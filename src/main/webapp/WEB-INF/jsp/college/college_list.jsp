					...
					<div class="page-content">
						<div class="row">
							<div class="col-xs-12">
								...
								<sf:form action="colleges" method="post" id="Paramform"
									class="form-horizontal">
									<input type="hidden" name="currentPage" id="currentPage" value="1" />
									<div class=" col-xs-12 table-header">学院列表</div>
									...
									<div class="form-group">
										<label class="col-sm-1 text-right">院系名</label>
										<div class="col-sm-2">
											<input type="text" class="col-xs-12" name="collegeName"
												value="${collegeInfo.collegeName }">
										</div>
										
										<label class="col-sm-1 text-right">院系负责人</label>
										<div class="col-sm-2">
											<input type="text" class="col-xs-12" name="collegePrincipal"
												value="${collegeInfo.collegePrincipal }">
										</div>
										
										<label class="col-sm-1 text-right">所属学校</label> 
										<div class="col-sm-2">
											<input type="text" class="form-control input-sm" name="school" value="${collegeInfo.school }">
										</div> 
