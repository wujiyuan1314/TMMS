					...
					<div class="page-content">
						<div class="row">
							<div class="col-xs-12">
								...
								<sf:form action="classs" method="post" id="Paramform"
									class="form-horizontal">
									<input type="hidden" name="currentPage" id="currentPage" value="1" />
									<div class=" col-xs-12 table-header">班级列表</div>
									...
									<div class="form-group">
										<label class="col-sm-1 contorl-label text-right">班级名</label>
										<div class="col-sm-2">
										...
										<div class="col-xs-12">
											<div class="col-sm-1">
												<input type="button" id="classs" value="查 询" />
											</div>
											<shiro:hasPermission name="class:addbatch">
											<div class="col-sm-1">
												<input type="button" id="classaddbatch" value="导入" />
											</div>
											</shiro:hasPermission>
											<shiro:hasPermission name="class:export">
											<div class="col-sm-1">
												<input type="button" id="classexport" value="导出" />
											</div>
											</shiro:hasPermission>
										</div>
										...
										<div class="col-sm-4">
											<div id="dynamic-table_filter" class="dataTables_filter">
												...
												<shiro:hasPermission name="class:dels">
												 <button class="btn btn-danger btn-sm" onclick="batchDelete('class');">
									...
									<table id="dynamic-table"
											...
											<tbody>
												<c:forEach items="${classs}" var="class1" varStatus="status">
													<tr>
														<td class="center"><input type="checkbox"
															name="Id" value="${class1.classId}" /></td>
														<td>${status.index + 1}</td>
														<td>${class1.className}</td>
														<td><location:specialtyName specialtyId="${class1.specialtyId}" ></location:specialtyName></td>
														<td><location:collegeName collegeId="${class1.collegeId}" ></location:collegeName></td>
														<td><code:itemname codeno="GRADE" itemno="${class1.grade}"></code:itemname></td>
														<td>${class1.monitorName}</td>
														<td>${class1.monitorLinkinfo}</td>
														<td>${class1.studentNum}</td>
														<td>${class1.paidStudentNum}</td>
														<td>
															<div class="hidden-sm hidden-xs action-buttons">
																...
																<shiro:hasPermission name="class:edit">
																 <a class="green" href="${class1.classId}/classedit">修改 <i
																	class="icon-edit"></i>
																</a>
																</shiro:hasPermission>
																<shiro:hasPermission name="class:del">
																 <a class="red" href="${class1.classId}/classdel">删除 <i
																	class="icon-trash"></i>
																</a>
																</shiro:hasPermission>
															</div>
