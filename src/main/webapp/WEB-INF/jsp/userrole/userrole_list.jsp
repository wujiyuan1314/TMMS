					...
					<div class="page-content">
						<div class="row">
							<div class="col-xs-12">
								...
								<sf:form action="userroles" method="post" id="Paramform"
									class="form-horizontal">
									<input type="hidden" name="currentPage" id="currentPage" value="1" />
									<div class=" col-xs-12 table-header">角色列表</div>
									...
									<div class="form-group">
										<label class="col-sm-1 contorl-label text-right">角色名</label>
										<div class="col-sm-2">
											<input type="text" class="col-xs-12"
												name="username" value="${userRole.roleName }">
										</div>
										...
										<div class="col-xs-12">
											<div class="col-sm-1">
												<input type="button" id="userroles" value="查 询" />
											</div>
										</div>
											...
											<tbody>
												<c:forEach items="${userroles}" var="userrole" varStatus="status">
													<tr>
														...
														<td>${userrole.state}</td>
														<td>
															<div class="hidden-sm hidden-xs action-buttons">
																<a class="blue" href="#"> <i
																	class="ace-icon fa fa-search-plus bigger-130"></i>
																</a> <a class="green" href="${userrole.id}/userroleedit">修改 <i
																	class="icon-edit"></i>
																</a> <a class="red" href="${userrole.id}/userroledel">删除 <i
																	class="icon-trash"></i>
																</a> <a class="blue" href="${userrole.id}/permissionset">权限设置 <i
																class="icon-folder-open"></i>
																</a> <a class="blue" href="${userrole.id}/menuset">菜单设置 <i
																class="icon-list"></i>
																</a>
															</div>
														</td>
